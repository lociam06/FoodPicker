        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Eat_time = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Rate = table.Column<int>(type: "int", nullable: true),
                    Min_price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Max_price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Healthy = table.Column<int>(type: "int", nullable: true),
                    Difficulty = table.Column<int>(type: "int", nullable: true),
                    Approximate_preparation_time = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
